...
function CartSec1() {
  return (
    <section className='w-[98%] h-auto hover:shadow-md shadow-slate-900/5   dark:shadow-cyan-400 border border-(--border-main) flex flex-col justify-between gap-2 m-auto p-7 rounded-4xl bg-white/90 dark:bg-slate-900/50 '>
