...
function Loader() {
  return (
    <div className="flex flex-col gap-y-2 items-center justify-center min-h-screen">
      ...
      <div className="flex font-semibold ml-6 gap-1">
        LOADING
        <div className="flex space-x-1 mt-4 justify-center items-center bg-white dark:invert">
          <div className="h-1.25 w-1.25 bg-black rounded-full animate-bounce [animation-delay:-0.3s]"></div>
          <div className="h-1.25 w-1.25 bg-black rounded-full animate-bounce [animation-delay:-0.15s]"></div>
          <div className="h-1.25 w-1.25 bg-black rounded-full animate-bounce"></div>
        </div>
      </div>
    </div>
  );
